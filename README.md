...
## تحديثات احترافية مضافة
- Dark Mode من شريط التنقل.
- PWA Web App: يمكن إضافة الموقع إلى شاشة الهاتف.
- بحث متقدم في صفحة المتطوعين حسب الاسم، الفريق، الحالة، المستوى، المهارات والأعمال.
- QR Code لكل متطوع يفتح صفحة ملفه الشخصي.
- بطاقة عضوية فاخرة لكل متطوع عبر الرابط: `/volunteers/[slug]/card` ويمكن طباعتها PDF.
- صفحة شفافية عبر `/transparency`.

## متغير إضافي مستحسن في Vercel
أضف داخل Environment Variables:
